...
#define DELTA
  ...
  #define DELTA_HEIGHT 338.4 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.85, -0.16 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 90.27 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.55, 1.20, 0.0 } // get these values from auto calibrate
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    43       // LED driving pin on motherboard 4 => D4 (EXP2-5 on Printrboard) / 30 => PC7 (EXP3-13 on Rumba)
